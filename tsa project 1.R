...
stocks.ar1.pred <- forecast(stocks.ar1, h = nValid, level = 0)
stocks.ar1.pred
...
lines(c(2022, 2022), c(0, 1800))
lines(c(2023, 2023), c(0, 1800))
text(2009, 35, "Training")
text(2022, 35, "Validation")
...
Acf(train.lin.season.pred$residuals, lag.max = 12, 
    main = "Autocorrelation for Houses Sold Training Residuals")
Acf(valid.ts - train.lin.season.pred$mean, lag.max = 12, 
    main = "Autocorrelation for Houses Sold Validation Residuals")
...
Acf(res.ar1$residuals, lag.max = 12, 
    main = "Autocorrelation for Houses Sold Training Residuals of Residuals")
